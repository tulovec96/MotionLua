...
// AES-256-GCM at-rest encryption for OAuth refresh tokens (Account.refresh_token).
...
function getKey(): Buffer {
  ...
  if (!raw) {
    throw new Error(
      "ENCRYPTION_KEY is not set — required to encrypt/decrypt OAuth refresh tokens."
    );
  }
